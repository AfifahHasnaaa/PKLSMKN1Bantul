  ...
  @extends('layout')
  @section('title')
  <title>List Pembimbing Instansi - Admin</title>
  @endsection
  @section('css')
  <style>
    .dataTables_filter {
  ...
  @section('content')
    <div class="pagetitle">
      <h1>Daftar Pembimbing Instansi</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item active">Daftar Pembimbing Instansi</li>
        </ol>
      </nav>
    </div>
 ...
 <script>
  $(document).ready(function() {
            $('#instansi-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('data.pembimbing.instansi') }}",
                columns: [
